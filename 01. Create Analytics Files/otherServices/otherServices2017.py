...
missingTable.write.saveAsTable("dua_058828_spa240.otherServicesMissing2017", mode='overwrite')

# COMMAND ----------

# Write DataFrame to CSV
#df = spark.table("dua_058828_spa240.otherServicesMissing2017")
#dbutils.fs.ls("s3://apcws301-transfer/dua/dua_058828/toSAS/")
#df.write.format('csv').option('header', 'true').mode('overwrite').save("dbfs:/mnt/dua/dua_058828/SPA240/files/ofState2017d.csv")
#dbutils.fs.ls("dbfs:/mnt/dua/dua_058828/SPA240/files")
#dbutils.fs.mv(f'dbfs:/mnt/dua/dua_058828/SPA240/files/ofState2017d.csv/', f's3://apcws301-transfer/dua/dua_058828/toSAS/ofState2017d.csv/', True)
...
missingTable.write.saveAsTable("dua_058828_spa240.otherServicesMissing2018", mode='overwrite')

# COMMAND ----------

# Write DataFrame to CSV
#df = spark.table("dua_058828_spa240.otherServicesMissing2018")
#dbutils.fs.ls("s3://apcws301-transfer/dua/dua_058828/toSAS/")
#df.write.format('csv').option('header', 'true').mode('overwrite').save("dbfs:/mnt/dua/dua_058828/SPA240/files/ofState2018d.csv")
#dbutils.fs.ls("dbfs:/mnt/dua/dua_058828/SPA240/files")
#dbutils.fs.mv(f'dbfs:/mnt/dua/dua_058828/SPA240/files/ofState2018d.csv/', f's3://apcws301-transfer/dua/dua_058828/toSAS/ofState2018d.csv/', True)
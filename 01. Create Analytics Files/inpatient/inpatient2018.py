...
missingTable.write.saveAsTable("dua_058828_spa240.inpatientMissing2018", mode='overwrite')
...
#df = spark.table("dua_058828_spa240.inpatientMissing2018")
#dbutils.fs.ls("s3://apcws301-transfer/dua/dua_058828/toSAS/")
#df.write.format('csv').option('header', 'true').mode('overwrite').save("dbfs:/mnt/dua/dua_058828/SPA240/files/inpatient2018.csv")
#dbutils.fs.ls("dbfs:/mnt/dua/dua_058828/SPA240/files")
#dbutils.fs.mv(f'dbfs:/mnt/dua/dua_058828/SPA240/files/inpatient2018.csv/', f's3://apcws301-transfer/dua/dua_058828/toSAS/inpatient2018.csv/', True)
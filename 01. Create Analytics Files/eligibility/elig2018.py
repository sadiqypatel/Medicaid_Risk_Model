...
test2 = spark.read.table("dua_058828_spa240.demo2018")
...
print((memberDf.count(), len(memberDf.columns)))
memberDf.write.saveAsTable("dua_058828_spa240.elig2018", mode='overwrite')
...
demoFile = spark.read.table("dua_058828_spa240.demo2018")
...
#print((memberDf.count(), len(memberDf.columns)))
memberDf.write.saveAsTable("dua_058828_spa240.member2018", mode='overwrite')
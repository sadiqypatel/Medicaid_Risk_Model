...
test2 = spark.read.table("dua_058828_spa240.demo2017")
...
print((memberDf.count(), len(memberDf.columns)))
memberDf.write.saveAsTable("dua_058828_spa240.elig2017", mode='overwrite')
...
demoFile = spark.read.table("dua_058828_spa240.demo2017")
...
print((memberDf.count(), len(memberDf.columns)))
memberDf.write.saveAsTable("dua_058828_spa240.member2017", mode='overwrite')
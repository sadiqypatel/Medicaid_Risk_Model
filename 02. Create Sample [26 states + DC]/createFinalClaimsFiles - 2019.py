...
#member
member = spark.table("dua_058828_spa240.finalSample2019")
...
#claims
other = spark.table("dua_058828_spa240.otherservices2019")
...
other.write.saveAsTable("dua_058828_spa240.otherservices_final2019", mode='overwrite')
...
inpatient.write.saveAsTable("dua_058828_spa240.inpatient_final2019", mode='overwrite')

# COMMAND ----------

#longTerm
longTerm = spark.table("dua_058828_spa240.longterm2019")
...
longTerm.write.saveAsTable("dua_058828_spa240.longterm_final2019", mode='overwrite')
...
#pharm
pharm = spark.table("dua_058828_spa240.pharm2019")
...
pharm.write.saveAsTable("dua_058828_spa240.pharm_final2019", mode='overwrite')

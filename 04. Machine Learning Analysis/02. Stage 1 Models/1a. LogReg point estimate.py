...
train_logReg.write.saveAsTable("dua_058828_spa240.train_log_reg", mode="overwrite")
test_logReg.write.saveAsTable("dua_058828_spa240.test_log_reg", mode="overwrite")

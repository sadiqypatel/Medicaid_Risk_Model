...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/stage1/LogReg with Regular point estimate")
...
final_estimator = LogisticRegression(featuresCol="features", labelCol='loseCoverage', **best_hyperparams)
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_logReg_withReg", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_logReg_withReg", mode="overwrite")

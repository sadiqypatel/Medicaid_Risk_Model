...
rf_classifier = RandomForestClassifier(featuresCol="features", labelCol="loseCoverage")
...
best_hyperparams = [
     {'minInstancesPerNode': 1,  'featureSubsetStrategy': "sqrt", 'maxDepth': 20, 'numTrees': 50}
]
...
rf = RandomForestClassifier(featuresCol="features", labelCol="loseCoverage",  **best_hyper)
...
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_rf_stage1", mode="overwrite")
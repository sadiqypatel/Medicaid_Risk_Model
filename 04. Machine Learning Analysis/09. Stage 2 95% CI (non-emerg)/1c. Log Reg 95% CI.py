...
test_no_sdoh = spark.table("dua_058828_spa240.stage2_non_emerg_test_log_reg_no_SDOH")
test_area_sdoh = spark.table("dua_058828_spa240.stage2_non_emerg_test_log_reg_area_SDOH")

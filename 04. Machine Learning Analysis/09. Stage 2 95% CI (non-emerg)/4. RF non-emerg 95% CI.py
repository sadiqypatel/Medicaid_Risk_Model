...
test_baseline = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg_base")
test_no_sdoh = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg_no_sdoh")
test_area_sdoh = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg_area_SDOH")
test_all_sdoh = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg")

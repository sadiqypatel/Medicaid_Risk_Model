...
test_baseline = spark.table("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_baseline")
test_no_sdoh = spark.table("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_no_SDOH")
test_area_sdoh = spark.table("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_area_SDOH")

# test_no_sdoh.printSchema()
# test_area_sdoh.printSchema()

# test_no_sdoh.show(10)
# test_area_sdoh.show(10)

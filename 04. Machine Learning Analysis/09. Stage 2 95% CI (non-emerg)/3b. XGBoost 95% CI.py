...
# test_baseline = spark.table("dua_058828_spa240.test_xg_boost_stage2_non_emerg_base")
test_no_sdoh = spark.table("dua_058828_spa240.test_xg_boost_stage2_non_emerg_no_SDOH1")
test_area_sdoh = spark.table("dua_058828_spa240.test_xg_boost_stage2_non_emerg_area_SDOH1")

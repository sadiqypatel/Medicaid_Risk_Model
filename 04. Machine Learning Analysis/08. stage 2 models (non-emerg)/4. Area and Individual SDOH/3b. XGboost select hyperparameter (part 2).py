...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/7. stage 2 models (non-emerg)/3b. XGboost select hyperparameter (part 2)")
...
for params in param_grid:
    ...
    xgb = XgboostClassifier(featuresCol="features", labelCol="non_emerg_binary", missing=0.0, **{param.name: value for param, value in params.items()})
    #print(xgb_model)

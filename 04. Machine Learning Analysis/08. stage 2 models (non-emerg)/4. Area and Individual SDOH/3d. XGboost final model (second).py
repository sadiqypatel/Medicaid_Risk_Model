...
sampled_df = df.select("beneID", "state", "features", "non_emerg_binary")
...
hyperparameters = [
    ...
    {'learning_rate': 0.005,  'subsample': 0.7, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 20, 'reg_alpha': 0.25, 'reg_lambda': 0.25, 'gamma': 1, 'colsample_bylevel': 0.5},
      ...
      {'learning_rate': 0.001,  'subsample': 0.7, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 16, 'reg_alpha': 0.0, 'reg_lambda': 0.25, 'gamma': 0, 'colsample_bylevel': 0.5},
    {'learning_rate': 0.001,  'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 22, 'reg_alpha': 0.5, 'reg_lambda': 0.25, 'gamma': 0, 'colsample_bylevel': 1},

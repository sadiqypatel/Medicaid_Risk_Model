...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/7. stage 2 models (non-emerg)/3c. XGboost final model")
...
# hyperparameters = [
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 18, 'reg_alpha': 0.0,  'reg_lambda': 0.25, 'gamma': 0,   'colsample_bylevel': 1},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 16, 'reg_alpha': 0.0,  'reg_lambda': 0.0,  'gamma': 0.5, 'colsample_bylevel': 1},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 20, 'reg_alpha': 0.0,  'reg_lambda': 0.5,  'gamma': 0,   'colsample_bylevel': 1},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 0.75, 'max_depth': 22, 'reg_alpha': 1.0,  'reg_lambda': 0.0,  'gamma': 1,   'colsample_bylevel': 1},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 20, 'reg_alpha': 0.5,  'reg_lambda': 0.0,  'gamma': 0,   'colsample_bylevel': 1},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 0.75, 'max_depth': 22, 'reg_alpha': 0.0,  'reg_lambda': 0.5,  'gamma': 1,   'colsample_bylevel': 1},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 16, 'reg_alpha': 0.5,  'reg_lambda': 0.0,  'gamma': 1,   'colsample_bylevel': 0.75},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 16, 'reg_alpha': 0.0,  'reg_lambda': 0.0,  'gamma': 0,   'colsample_bylevel': 1},
#     {'learning_rate': 0.01,  'subsample': 0.2, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 20, 'reg_alpha': 1.0,  'reg_lambda': 0.25, 'gamma': 0,   'colsample_bylevel': 1},
  
#     {'learning_rate': 0.005,  'subsample': 0.3, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 18, 'reg_alpha': 0.0,  'reg_lambda': 0.25, 'gamma': 0, 'colsample_bylevel': 1},
#     {'learning_rate': 0.005,  'subsample': 0.3, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 16, 'reg_alpha': 0.25, 'reg_lambda': 0.0,  'gamma': 1, 'colsample_bylevel': 1},
#     {'learning_rate': 0.005,  'subsample': 0.3, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 16, 'reg_alpha': 0.5,  'reg_lambda': 0.0,  'gamma': 0, 'colsample_bylevel': 1},
#     {'learning_rate': 0.01,   'subsample': 0.3, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 20, 'reg_alpha': 0.5,  'reg_lambda': 0.0,  'gamma': 0, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.005,  'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 22, 'reg_alpha': 0.25, 'reg_lambda': 0.25, 'gamma': 1, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.005,  'subsample': 0.7, 'min_child_weight': 0, 'colsample_bytree': 1.0,  'max_depth': 20, 'reg_alpha': 0.25, 'reg_lambda': 0.25, 'gamma': 1, 'colsample_bylevel': 0.5}
...
final_estimator = XgboostClassifier(featuresCol="features", labelCol='non_emerg_binary', missing=0.0, **best_hyperparams)
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_boost_stage2_nonemerg", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_boost_stage2_nonemerg", mode="overwrite")

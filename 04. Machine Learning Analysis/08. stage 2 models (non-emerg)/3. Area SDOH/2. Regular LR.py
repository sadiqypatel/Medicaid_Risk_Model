...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/SDOH analysis/7b. Regular LR non-emerg are SDOH")
...
final_estimator = LogisticRegression(featuresCol="features", labelCol='non_emerg_binary', **best_hyperparams)
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_train_non_emerg_logReg_withReg_area_SDOH", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_area_SDOH", mode="overwrite")
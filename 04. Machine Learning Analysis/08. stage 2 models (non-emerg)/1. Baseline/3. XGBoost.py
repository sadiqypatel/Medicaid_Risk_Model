...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/8. stage 2 base model (cdps equiv)/8. XGboost non-emerg")
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_boost_stage2_non_emerg_base", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_boost_stage2_non_emerg_base", mode="overwrite")
...
train_logReg.write.saveAsTable("dua_058828_spa240.stage2_non_emerg_train_log_reg_base", mode="overwrite")
test_logReg.write.saveAsTable("dua_058828_spa240.stage2_non_emerg_test_log_reg_base", mode="overwrite")

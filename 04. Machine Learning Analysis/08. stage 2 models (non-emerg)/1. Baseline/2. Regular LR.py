...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/SDOH analysis/7c. Regular LR non-emerg baseline")
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_train_non_emerg_logReg_withReg_baseline", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_baseline", mode="overwrite")
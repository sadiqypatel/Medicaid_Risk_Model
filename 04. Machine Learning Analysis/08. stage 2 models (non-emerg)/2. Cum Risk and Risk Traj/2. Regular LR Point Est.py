...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/SDOH analysis/7a. Regular LR non-emerg no SDOH")
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_train_non_emerg_logReg_withReg_no_SDOH", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_no_SDOH", mode="overwrite")
...
df = spark.table("dua_058828_spa240.sensitivity_best_model_no_race_5million")
print(df.count())
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_nonemerg_sensitivity_no_race", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_nonemerg_sensitivity_no_race", mode="overwrite")

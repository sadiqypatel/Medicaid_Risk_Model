...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_allcause_sensitivity_no_race", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_allcause_sensitivity_no_race", mode="overwrite")

...
df = spark.table("dua_058828_spa240.stage2_random_sample_5million_vector_adults")
print(df.count())
...
mlflow.set_experiment("/Users/SPA240/Paper 1/analysis/SDOH analysis/2a. XGboost no race non-emerg")
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_non_emerg_sensitivity_adults", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_non_emerg_sensitivity_adults", mode="overwrite")

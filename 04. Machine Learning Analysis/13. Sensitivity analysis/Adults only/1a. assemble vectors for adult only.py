...
df = spark.table("dua_058828_spa240.stage2_random_sample_5million_adults_only")
...
# transformed_data.write.saveAsTable("dua_058828_spa240.stage2_random_sample_5million_vector_assembler", mode='overwrite')

transformed_data = transformed_data.select("beneID", "state", "features", "all_cause_acute_post", "avoid_acute_post")
transformed_data.write.saveAsTable("dua_058828_spa240.stage2_random_sample_5million_vector_adults", mode='overwrite')

...
# Create a SparkSession with a specific number of executor cores
spark = SparkSession.builder \
    .appName("example") \
    .config("spark.executor.cores", "10").getOrCreate()
...
xgb = XgboostClassifier(featuresCol="features", labelCol="non_emerg_binary", missing=0.0, **best_hyper, nthread=4)
...
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_boost_stage2_non_emerg_downsample_30p", mode="overwrite")
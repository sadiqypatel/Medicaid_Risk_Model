...
down_sample_1 = spark.table("dua_058828_spa240.test_rf_all_cause_down_sample_1")
down_sample_2 = spark.table("dua_058828_spa240.test_rf_all_cause_down_sample_2")
...
for n_iterations in iteration_levels:
    aucs, mccs, accuracies, sensitivities, specificities, npvs, ppvs = bootstrap_metrics(down_sample_1, n_iterations, fraction)
...
for n_iterations in iteration_levels:
    aucs, mccs, accuracies, sensitivities, specificities, npvs, ppvs = bootstrap_metrics(down_sample_2, n_iterations, fraction)
    train_aucs_list.append(np.mean(aucs))
    train_mccs_list.append(np.mean(mccs))
    train_accuracies_list.append(np.mean(accuracies))
    train_sensitivities_list.append(np.mean(sensitivities))

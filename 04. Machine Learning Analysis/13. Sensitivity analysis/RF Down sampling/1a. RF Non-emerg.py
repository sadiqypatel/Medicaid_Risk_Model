...
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_rf_down_sample_1", mode="overwrite")
...
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_rf_down_sample_2", mode="overwrite")
...
# stage2_test_non_emerg_logReg_withReg_baseline
# stage2_test_non_emerg_logReg_withReg_no_SDOH
# stage2_test_non_emerg_logReg_withReg_area_SDOH
# stage2_test_non_emerg_logReg_withReg
...
test_df = spark.table("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_baseline")
...
test_df = spark.table("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_no_SDOH")
...
test_df = spark.table("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg_area_SDOH")
...
test_df = spark.table("dua_058828_spa240.stage2_test_non_emerg_logReg_withReg")

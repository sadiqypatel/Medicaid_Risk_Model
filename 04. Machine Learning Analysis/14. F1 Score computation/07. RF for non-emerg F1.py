...
test_df = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg_base")
...
test_df = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg_no_sdoh")
...
test_df = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg_area_SDOH")
...
test_df = spark.table("dua_058828_spa240.test_rf_stage2_nonemerg")

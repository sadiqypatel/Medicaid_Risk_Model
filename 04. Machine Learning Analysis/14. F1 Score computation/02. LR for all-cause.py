...
# stage2_baseline_all_cause_test_log_reg
# stage2_all_cause_test_log_reg_noSDOH
# stage2_all_cause_test_log_reg_areaSDOH
# stage2_all_cause_test_log_reg
...
test_df = spark.table("dua_058828_spa240.stage2_all_cause_test_log_reg_noSDOH")
...
test_df = spark.table("dua_058828_spa240.stage2_all_cause_test_log_reg_areaSDOH")
...
test_df = spark.table("dua_058828_spa240.stage2_all_cause_test_log_reg")

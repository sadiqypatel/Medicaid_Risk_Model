...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/1. xgboost all features")
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_all_features", mode="overwrite")

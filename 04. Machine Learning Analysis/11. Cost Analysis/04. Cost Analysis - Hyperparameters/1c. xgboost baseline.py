...
from pyspark.sql import SparkSession
import pandas as pd
from pyspark.sql.types import IntegerType, StringType, StructType, Struct Field
import numpy as np
import mlflow
import mlflow.spark
from pyspark.sql import SparkSession
...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/3. xgboost baseline")
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_baseline", mode="overwrite")

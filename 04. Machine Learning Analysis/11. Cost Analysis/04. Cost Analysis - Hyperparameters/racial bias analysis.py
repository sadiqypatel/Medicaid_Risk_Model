...
test_disabled = spark.table("dua_058828_spa240.test_cost_SDOH_only_disabled")
...
# Perform the left merge on 'beneID' and 'state' columns
test_adults = spark.table("dua_058828_spa240.test_cost_baseline_adults")
...
# Perform the left merge on 'beneID' and 'state' columns
test_kids = spark.table("dua_058828_spa240.test_cost_all_features_kids")
...
bootstrap_means = perform_bootstrap(df_adults, "race_category", "diff", sample_fraction=0.1, num_iterations=1000)
#print(step1)
...
bootstrap_means = perform_bootstrap(df_kids, "race_category", "diff", sample_fraction=0.1, num_iterations=1000)
#print(step1)
...
bootstrap_means = perform_bootstrap(df_disabled, "race_category", "diff", sample_fraction=0.1, num_iterations=1000)
#print(step1)

...
def bootstrap_metrics(df, n_iterations, fraction):
    ...
    for _ in range(n_iterations):
        ...
        bootstrap_sample = bootstrap_sample.withColumn("diff", (col("total_cost") - col("prediction")))
...
df1 = spark.table("dua_058828_spa240.test_cost_baseline_adults")
df2 = spark.table("dua_058828_spa240.test_cost_no_SDOH_adults")
df3 = spark.table("dua_058828_spa240.test_cost_SDOH_only_adults")
df4 = spark.table("dua_058828_spa240.test_cost_all_features_adults")
...
test_df = spark.table("dua_058828_spa240.test_cost_baseline_adults")
#test_df.printSchema()
...
test_df = spark.table("dua_058828_spa240.test_cost_no_SDOH_adults")
#test_df.printSchema()
...
test_df = spark.table("dua_058828_spa240.test_cost_SDOH_only_adults")
print(test_df.count())
#test_df.printSchema()
...
test_df = spark.table("dua_058828_spa240.test_cost_all_features_adults")
print(test_df.count())
#test_df.printSchema()

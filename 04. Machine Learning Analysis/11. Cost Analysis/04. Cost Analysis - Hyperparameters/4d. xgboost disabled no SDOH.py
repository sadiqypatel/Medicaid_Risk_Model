...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/4d. xgboost disabled no SDOH")
mlflow.set_tracking_uri("databricks")

# COMMAND ----------

xgb_classifier = XgboostRegressor(labelCol="total_cost", featuresCol="features_no_sdoh", missing=0.0)
...
for params in param_grid:
    ...
    param_dict = {param.name: value for param, value in params.items()}
    xgb_model = XgboostRegressor(labelCol="total_cost", featuresCol="features_no_sdoh", missing=0.0)
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_no_SDOH_disabled", mode="overwrite")

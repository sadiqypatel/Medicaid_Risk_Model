...
df = spark.table("dua_058828_spa240.paper1_stage2_final_data_adults_2M")
...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/2b. xgboost adults area SDOH")
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_SDOH_only_adults", mode="overwrite")

...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/2a. xgboost adults all features")
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_all_features_adults", mode="overwrite")

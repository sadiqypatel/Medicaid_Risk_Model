...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/4c. xgboost disabled baseline")
mlflow.set_tracking_uri("databricks")

# COMMAND ----------

xgb_classifier = XgboostRegressor(labelCol="total_cost", featuresCol="features_baseline", missing=0.0)
...
final_model = XgboostRegressor(labelCol="total_cost", featuresCol="features_baseline", missing=0.0)
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_baseline_disabled", mode="overwrite")

...
df = spark.table("dua_058828_spa240.paper1_stage2_final_data_disabled_2M")
...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/4b. xgboost disabled area SDOH")
mlflow.set_tracking_uri("databricks")

# COMMAND ----------

xgb_classifier = XgboostRegressor(labelCol="total_cost", featuresCol="features_area_sdoh", missing=0.0)
...
final_model = XgboostRegressor(labelCol="total_cost", featuresCol="features_area_sdoh", missing=0.0)
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_SDOH_only_disabled", mode="overwrite")

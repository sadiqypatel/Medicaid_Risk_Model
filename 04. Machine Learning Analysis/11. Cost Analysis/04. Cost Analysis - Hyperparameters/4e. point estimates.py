...
df1 = spark.table("dua_058828_spa240.test_cost_baseline_disabled")
df2 = spark.table("dua_058828_spa240.test_cost_no_SDOH_disabled")
df3 = spark.table("dua_058828_spa240.test_cost_SDOH_only_disabled")
df4 = spark.table("dua_058828_spa240.test_cost_all_features_disabled")

from pyspark.sql import functions as F
true_cost = df1.select(F.mean("total_cost")).collect()[0][0]
pred_cost1 = df1.select(F.mean("prediction")).collect()[0][0]
pred_cost2 = df2.select(F.mean("prediction")).collect()[0][0]
pred_cost3 = df3.select(F.mean("prediction")).collect()[0][0]
true_cost = df4.select(F.mean("total_cost")).collect()[0][0]
pred_cost4 = df4.select(F.mean("prediction")).collect()[0][0]
...
test_df = spark.table("dua_058828_spa240.test_cost_baseline_disabled")
#test_df.printSchema()
...
test_df = spark.table("dua_058828_spa240.test_cost_no_SDOH_disabled")
#test_df.printSchema()
...
test_df = spark.table("dua_058828_spa240.test_cost_SDOH_only_disabled")
#test_df.printSchema()
...
test_df = spark.table("dua_058828_spa240.test_cost_all_features_disabled")
#test_df.printSchema()

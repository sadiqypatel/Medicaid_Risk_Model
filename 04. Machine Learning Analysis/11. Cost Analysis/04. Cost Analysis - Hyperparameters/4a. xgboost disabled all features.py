...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost new hyper/4a. xgboost disabled all features")
...
test_predictions.write.saveAsTable("dua_058828_spa240.test_cost_all_features_disabled", mode="overwrite")

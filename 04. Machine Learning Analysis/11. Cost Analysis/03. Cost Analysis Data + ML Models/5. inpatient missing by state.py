...
#inpatient claims
inpatient = spark.table("dua_058828_spa240.paper1_stage2_inpatient_cost")
...
inpatient_missing = inpatient.withColumn("missingFFS", when((col("CLM_TYPE_CD") == "1") & (col("MDCD_PD_AMT").isNull()), lit(1)).otherwise(lit(0)))

...
df = spark.table("dua_058828_spa240.paper1_stage2_final_data_disabled")
...
sampled_df = sampled_df.select("features_no_sdoh", "total_cost")
...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost analysis/9999a. xgboost disabled no sdoh")

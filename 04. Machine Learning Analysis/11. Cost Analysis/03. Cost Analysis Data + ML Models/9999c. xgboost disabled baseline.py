...
sampled_df = sampled_df.select("features_baseline", "total_cost")
...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost analysis/9999c. xgboost disabled baseline")

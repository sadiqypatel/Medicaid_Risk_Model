...
sampled_df = sampled_df.select("features_all_sdoh", "total_cost")
...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/cost analysis/9999b. xgboost disabled all features")

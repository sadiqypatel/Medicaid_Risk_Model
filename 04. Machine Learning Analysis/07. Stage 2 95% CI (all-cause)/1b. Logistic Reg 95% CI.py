...
test_no_sdoh = spark.table("dua_058828_spa240.stage2_all_cause_test_log_reg_noSDOH")
test_area_sdoh = spark.table("dua_058828_spa240.stage2_all_cause_test_log_reg_areaSDOH")

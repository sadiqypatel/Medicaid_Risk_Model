...
test_baseline = spark.table("dua_058828_spa240.stage2_test_all_cause_logReg_withReg_baseline")
test_no_sdoh = spark.table("dua_058828_spa240.stage2_test_all_cause_logReg_withReg_no_SDOH")
test_area_sdoh = spark.table("dua_058828_spa240.stage2_test_all_cause_logReg_withReg_area_SDOH")

...
#mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/6. stage 2 models (all-cause)/1a. LogReg point estimate")
...
final_estimator = LogisticRegression(labelCol='all_cause_binary', **best_hyperparams)
...
train_logReg = train_logReg.select('beneID', 'state', 'probability_col', 'probability', 'rawPrediction', 'prediction', 'all_cause_binary')
...
# Select specific columns
test_logReg = test_logReg.select('beneID', 'state', 'probability_col', 'probability', 'rawPrediction', 'prediction', 'all_cause_binary')
...
train_logReg.write.saveAsTable("dua_058828_spa240.stage2_all_cause_train_log_reg_areaSDOH", mode="overwrite")
test_logReg.write.saveAsTable("dua_058828_spa240.stage2_all_cause_test_log_reg_areaSDOH", mode="overwrite")
...
sampled_df = df.select("beneID", "state", "features", "all_cause_binary")
...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/6. stage 2 models (all-cause)/3c. XGboost final model")
...
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 18, 'reg_alpha': 0.25, 'reg_lambda': 0.0,  'gamma': 1, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 18, 'reg_alpha': 0.5,  'reg_lambda': 0.5,  'gamma': 0, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 20, 'reg_alpha': 0.0,  'reg_lambda': 0.5,  'gamma': 1, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 20, 'reg_alpha': 0.0,  'reg_lambda': 0.25, 'gamma': 0, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.005,  'subsample': 1.0, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 20, 'reg_alpha': 0.0,  'reg_lambda': 0.0,  'gamma': 1, 'colsample_bylevel': 1},
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 22, 'reg_alpha': 0.0,  'reg_lambda': 0.5,  'gamma': 0, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 20, 'reg_alpha': 0.0,  'reg_lambda': 0.25, 'gamma': 0, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 18, 'reg_alpha': 0.25, 'reg_lambda': 0.0,  'gamma': 0, 'colsample_bylevel': 0.5},
...
# hyperparameters = [
#     {'learning_rate': 0.005,  'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 22, 'reg_alpha': 0.5,  'reg_lambda': 0.5,  'gamma': 0, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.7, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 18, 'reg_alpha': 0.25,  'reg_lambda': 0.0,  'gamma': 1, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.7, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 18, 'reg_alpha': 0.5,  'reg_lambda': 0.5, 'gamma': 0, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,   'subsample': 0.5, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 20, 'reg_alpha': 0.0, 'reg_lambda': 0.5,  'gamma': 1, 'colsample_bylevel': 0.5},
#     {'learning_rate': 0.01,  'subsample': 0.7, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 20, 'reg_alpha': 0.0, 'reg_lambda': 0.25, 'gamma': 0, 'colsample_bylevel': 0.5}
#     # Add more dictionaries for other sets of hyperparameters
# ]

hyperparameters = [
    {'learning_rate': 0.005,  'subsample': 0.6, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 22, 'reg_alpha': 0.5,  'reg_lambda': 0.5,  'gamma': 0, 'colsample_bylevel': 0.5},
    {'learning_rate': 0.005,  'subsample': 0.7, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 22, 'reg_alpha': 0.5,  'reg_lambda': 0.5,  'gamma': 0, 'colsample_bylevel': 0.5},
      {'learning_rate': 0.005,  'subsample': 0.8, 'min_child_weight': 0, 'colsample_bytree': 1.0, 'max_depth': 22, 'reg_alpha': 0.5,  'reg_lambda': 0.5,  'gamma': 0, 'colsample_bylevel': 0.5}
    # Add more dictionaries for other sets of hyperparameters
]
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_boost_stage2_allcause1", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_boost_stage2_allcause1", mode="overwrite")

...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_boost_stage2_allcause", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_boost_stage2_allcause", mode="overwrite")

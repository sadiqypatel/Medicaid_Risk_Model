...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/6. stage 2 models (all-cause)/3e. XGboost final model")
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.train_xg_boost_stage2_allcause_new1", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.test_xg_boost_stage2_allcause_new1", mode="overwrite")

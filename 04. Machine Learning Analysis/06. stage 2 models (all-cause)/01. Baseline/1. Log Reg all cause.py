...
train_logReg.write.saveAsTable("dua_058828_spa240.stage2_baseline_all_cause_train_log_reg", mode="overwrite")
test_logReg.write.saveAsTable("dua_058828_spa240.stage2_baseline_all_cause_test_log_reg", mode="overwrite")

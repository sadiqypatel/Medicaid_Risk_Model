...
mlflow.set_experiment("/Users/SPA240/riskScoreCode/analysis/SDOH analysis/6c. Regular LR all-cause baseline")
...
train_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_train_all_cause_logReg_withReg_baseline", mode="overwrite")
test_logReg_withReg.write.saveAsTable("dua_058828_spa240.stage2_test_all_cause_logReg_withReg_baseline", mode="overwrite")